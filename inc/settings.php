...
$settings['adminemail'] = "schmatzler@hirnschwund.net";
...
$settings['boardclosed_reason'] = "Kurze Datenbank-Wartungs-Pause.";
$settings['bbname'] = "hirnschwund-NEU";
...
$settings['avatarsize'] = "489";
$settings['maxattachments'] = "5";
$settings['maxavatardims'] = "150";
